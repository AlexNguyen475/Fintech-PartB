...
## Changelog v2.1 (26/04/2026)

| Thay đổi | Chi tiết |
|----------|---------|
| ✅ Fix timezone | Dùng `pytz Asia/Ho_Chi_Minh` — timestamp luôn hiển thị đúng giờ Hà Nội (UTC+7) thay vì giờ server Colab (UTC+0) |
| ✅ Cập nhật PAIRS | 20 mã đã xác nhận có trên MEXC Demo: thêm NVDA, TSLA, META, MSTR, PLTR, AMD, XAUT, WTI |
| ✅ Bỏ mã lỗi | Xóa ADA, AVAX, DOT, NEAR, MATIC, UNI, ATOM, LTC, APT, OP, INJ — không có trên MEXC Demo |
| ✅ Thêm thư viện | Cần cài thêm `pytz` — xem Bước 3 |
...
> ⚠️ **v2.1 yêu cầu thêm `pytz`** để fix timezone Hà Nội. Nếu thiếu thư viện này, timestamp sẽ bị lệch 7 tiếng.
...
## 10. Danh sách 20 cặp USDT-M Futures (v2.1 — đã xác nhận trên MEXC Demo)

| Nhóm | Cặp | Lý do chọn |
|------|-----|-----------|
| Crypto majors | BTC, ETH, SOL, XRP, DOGE, SUI | Thanh khoản cao nhất, tín hiệu tin cậy |
| Crypto mid | LINK, ARB, SEI, TRX, SHIB, PEPE | Biến động mạnh, hay có RSI cực đoan |
| Cổ phiếu tokenized | NVDA, TSLA, META, MSTR, PLTR, AMD | Biến động theo tin tức thị trường Mỹ |
| Hàng hóa | XAUT (vàng), WTI (dầu) | Đa dạng hóa, nhạy với địa chính trị |

> **Lưu ý**: Các mã ADA, AVAX, DOT, NEAR, MATIC, UNI, ATOM, LTC, APT, OP, INJ không có trên MEXC Demo và đã được loại bỏ trong v2.1.
